...
export function Row({ row, selected, wallets }) {
  const [open, setOpen] = React.useState(false);

  const handleOpen = ({ currentTarget: { id } }) => {
    setOpen(!open);
  };
      ...
      <TableCell align="left">
        <Stack>
          <a
            ...
            target="_blank"
            href={`https://gw-mainnet-explorer.nervosdao.community/tx/${hash}/internal-transactions`}
          >
